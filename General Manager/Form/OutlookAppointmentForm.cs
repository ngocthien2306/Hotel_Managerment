...
namespace General_Manager.Form
{
    ...
    public partial class OutlookAppointmentForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        ...
        protected internal virtual void OnRecurrenceButton()
        {
            ...
            DialogResult result;
            using (XtraForm form = CreateAppointmentRecurrenceForm(patternCopy, Control.OptionsView.FirstDayOfWeek))
            {
        ...
        protected virtual DialogResult ShowRecurrenceForm(XtraForm form)
        {
            return FormTouchUIAdapter.ShowDialog(form, this);
        }
        protected internal virtual XtraForm CreateAppointmentRecurrenceForm(Appointment patternCopy, FirstDayOfWeek firstDayOfWeek)
        {
